...
**Hint**: _Although it's called the **Space Toggle**, the part when the value of the custom property toggles to the `initial` keyword is **as important** as when it toggles to the `whitespace` value._
